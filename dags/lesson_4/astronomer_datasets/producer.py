...
INSTRUCTIONS = Dataset("file://localhost/airflow/data/cocktail_instructions.txt")
INFO = Dataset("file://localhost/airflow/data/cocktail_info.txt")
...
def write_instructions_to_file_func(response):
    ...
    f = open("data/cocktail_instructions.txt", "a")
    f.write(msg)
    f.close()
...
def write_info_to_file_func(response):
    ...
    f = open("data/cocktail_info.txt", "a")
    f.write(msg)
    f.close()
