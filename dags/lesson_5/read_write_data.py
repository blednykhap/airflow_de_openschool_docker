...
with DAG(
    ...
    def get_csv_files(regions, **kwargs):
        ...
        return [[dedent(f'/opt/airflow/data/regions_random/{r}/{kwargs["ds"]}.csv')] for r in regions]
    ...
    ls_files = BashOperator(task_id="ls_files", bash_command=spark_read_task.output)
